...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return PHMConv2d(4, in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=1, bias=False)
...
def downsample_basic_block( inplanes, outplanes, stride ):
    return  nn.Sequential(
                ...
                PHMConv2d(4, inplanes, outplanes, kernel_size=1, stride=stride, bias=False),
...
def downsample_basic_block_v2( inplanes, outplanes, stride ):
    return  nn.Sequential(
                ...
                PHMConv2d(4, inplanes, outplanes, kernel_size=1, stride=1, bias=False),
                nn.BatchNorm2d(outplanes),
            )
